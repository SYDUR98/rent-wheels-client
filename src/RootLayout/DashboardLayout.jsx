      ...
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-content">
          ...
          <nav className="navbar w-full bg-base-300">
            ...
            <div className="px-4">Rent Wheels Dashbord</div>
          </nav>
          {/* Page content here */}
          <Outlet></Outlet>
        </div>
            ...
            <ul className="menu w-full grow">
              ...
              {role === "carsDealer" && (
                <>
                  <li>
                    <NavLink
                      to="/dashboard/cars-delars/cars-delar-home"
                      className={({ isActive }) =>
                        `flex items-center gap-2 px-2 py-1 rounded-md transition-colors duration-300 
                    is-drawer-close:tooltip is-drawer-close:tooltip-right
                    ${
                      ...
                      data-tip="Cars Delars Status"
                    >
                      <SiGooglecampaignmanager360 className="text-lg" />
                      <span className="is-drawer-close:hidden">Cars Delars</span>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink
                      to="/dashboard/cars-delars/add-cars"
                      className={({ isActive }) =>
                        `flex items-center gap-2 px-2 py-1 rounded-md transition-colors duration-300 
                    is-drawer-close:tooltip is-drawer-close:tooltip-right
                    ${
                    ...
                    >
                      <SiNginxproxymanager className="text-lg" />
                      <span className="is-drawer-close:hidden">Add Cars</span>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink
                      to="/dashboard/cars-delars/my-cars"
                      className={({ isActive }) =>
                        `flex items-center gap-2 px-2 py-1 rounded-md transition-colors duration-300 
                    is-drawer-close:tooltip is-drawer-close:tooltip-right
                    ${
                ...
                <>
                  <li>
                    ...
                    >
                      ...
                      <span className="is-drawer-close:hidden">User Status</span>
                    </NavLink>
                  </li>
